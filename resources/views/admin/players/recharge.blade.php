    ...
    <main class="flex-1 ml-64 p-8 h-screen overflow-hidden flex flex-col">
        ...
        <div class="mb-8 shrink-0 flex items-center justify-between">
            <div>
                ...
                <h2 class="text-3xl font-[900] text-slate-900 tracking-tight uppercase leading-none">Caisse Admin</h2>
            </div>
            
            <div class="bg-white px-6 py-4 rounded-[2rem] flex items-center gap-4 border border-slate-100 shadow-sm">
                <div class="w-12 h-12 bg-slate-900 text-emerald-400 rounded-2xl flex items-center justify-center font-black text-lg border-2 border-slate-800">
                    {{ strtoupper(substr($player->name, 0, 2)) }}
                </div>
                <div>
                    <h3 class="font-black text-slate-900 uppercase tracking-tight leading-none text-base">{{ $player->name }}</h3>
        ...
        <form id="recharge-form" action="{{ route('admin.players.recharge.process', ['id' => $player->id]) }}" method="POST" class="grid grid-cols-12 gap-10 flex-1 min-h-0">
            ...
            <div class="col-span-7 flex flex-col min-h-0">
                <h3 class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-3 shrink-0">Options de recharge</h3>
                ...
                <div class="grid grid-cols-2 gap-6 overflow-y-auto pr-4 pt-6 pb-10 custom-scrollbar min-h-0">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <div class="pack-card bg-white p-8 rounded-[2.5rem] flex flex-col items-center text-center">
                            ...
                            <p class="text-slate-500 font-black text-[10px] mt-2 uppercase tracking-widest">100 DH à encaisser</p>
                        </div>
                    </label>
                    ...
                    <label class="cursor-pointer">
                        ...
                        <div class="pack-card bg-white p-8 rounded-[2.5rem] flex flex-col items-center text-center">
                            <div class="absolute -top-3 left-1/2 -translate-x-1/2 bg-slate-900 text-white text-[8px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest">Popular Choice</div>
                            <h4 class="text-2xl font-[900] text-slate-900 tracking-tight uppercase">500 PC</h4>
                            <p class="text-emerald-600 font-black text-[10px] mt-2 uppercase tracking-widest">450 DH à encaisser</p>
                        </div>
                    </label>
                    ...
                    <label class="cursor-pointer">
                        ...
                        <div class="pack-card bg-white p-8 rounded-[2.5rem] flex flex-col items-center text-center">
                            ...
                            <p class="text-slate-500 font-black text-[10px] mt-2 uppercase tracking-widest">1000 DH à encaisser</p>
                        </div>
                    </label>
            ...
            <div class="col-span-5 flex flex-col min-h-0">
                <h3 class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-6 shrink-0 text-right">Confirmation</h3>
                ...
                <div class="bg-white rounded-[3rem] border border-slate-100 shadow-sm p-8 flex flex-col flex-1 min-h-0">
                    <div class="bg-slate-900 rounded-[2.5rem] p-8 mb-8 text-center relative overflow-hidden group">
                        ...
                        <p class="text-[10px] font-black text-slate-500 uppercase mb-3 tracking-widest">Plaza Coins à injecter</p>
                        <div class="flex items-center justify-center gap-2 relative z-10">
                            <span id="display-amount" class="text-6xl font-[900] text-white tracking-tight">100</span>
                            <span class="text-2xl font-black text-emerald-500 uppercase">PC</span>
                        </div>
                    </div>
                    ...
                    <div class="flex-1">
                        <div class="flex items-start gap-4 bg-blue-50 p-5 rounded-3xl border border-blue-100">
                            ...
                            <p class="text-[10px] text-blue-700 font-black leading-relaxed uppercase tracking-tight">
