    ...
    <main class="flex-1 lg:ml-64 p-6 lg:p-10 mt-16 lg:mt-0">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div class="bg-slate-900 rounded-[3rem] p-10 text-center flex flex-col items-center justify-center shadow-2xl shadow-slate-200 relative overflow-hidden h-fit">
                ...
                <h3 class="text-xl font-black text-white uppercase tracking-tight leading-none">{{ Auth::user()->name }}</h3>
                <p class="text-emerald-400 text-[10px] font-black uppercase tracking-[0.3em] mt-3">{{ Auth::user()->role }}</p>
                
                <div class="mt-8 pt-8 border-t border-white/5 w-full flex justify-between items-center px-2">
                    <div class="text-left">
                        <p class="text-slate-500 text-[9px] font-black uppercase">Solde Actuel</p>
                        <p class="text-white font-black text-lg tracking-tight">{{ Auth::user()->coins ?? 0 }} <span class="text-emerald-500 text-xs">PC</span></p>
                    </div>
                    <div class="text-right">
                        <p class="text-slate-500 text-[9px] font-black uppercase">Inscrit en</p>
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-100 p-10 shadow-sm relative overflow-hidden group">
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <h4 class="text-sm font-black text-slate-900 uppercase tracking-widest">Informations du profil</h4>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="group">
                                ...
                                <input type="text" name="name" value="{{ Auth::user()->name }}" 
                                    ...
                                    class="w-full mt-2 px-6 py-4 rounded-2xl font-bold outline-none transition-all border-2 border-transparent {{ Auth::user()->role !== 'admin' ? 'input-locked' : 'bg-slate-50 focus:bg-white focus:border-emerald-500' }}">
                            </div>
                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-100 p-10 shadow-sm group">
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <h4 class="text-sm font-black text-slate-900 uppercase tracking-widest">Sécurité & Mot de passe</h4>
                    </div>
